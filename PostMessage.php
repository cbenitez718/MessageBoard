...
<body>
	<?php
		...
		if(isset($_POST["submit"])) {
			...
			// Check that the file both exists AND has at least one message before continuing
			...
			// check the new subject against the ExistingSubject array
